...
Gem::Specification.new do |s|
  ...
  s.description = 'At the moment it basically disables hosts on puppetdb after they are deleted in Foreman. Follow https://github.com/theforeman/puppetdb_foreman and raise an issue/submit a pull request if you need extra functionality'
